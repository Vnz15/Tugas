            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="{{asset('template')}}/dist/img/vnss.jpg" class="user-image" alt="User Image">
                  <span class="hidden-xs">Vanos Wijaya</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="{{asset('template')}}/dist/img/vnss.jpg" class="img-circle" alt="User Image">
                    <p>
                      Vanos Wijaya - Web Developer
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="pull-left image">
              <img src="{{asset('template')}}/dist/vnss.jpg" class="img-circle" alt="User Image">
            </div>
